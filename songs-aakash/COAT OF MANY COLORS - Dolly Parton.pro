...
[INTRO] [(Form][G][)][:]       [g][-][G][,]     [b][-][G][,]     [d][-][G][,]     [(Form][C][)]    [e][-][C][;]

             [(Form][G][)][:]       [g][-][G][,]     [b][-][G][,]     [d][-][G][,]     [(Form][C][)]    [e][-][C]

[G]Back through the years I go wondering once again, back to the seasons of my [C]youth.
I re[G]call a box of rags that someone gave us, and how my momma put the rags to [C]use.
