...
TIP:  The intro/outro emulates the saxophone that begins and ends the song.  It looks like a mess but just go through it a couple of times and it's not so bad.  The first line are the individual notes and the second line is how to play them from within chords.  In either case the sax note <a> begins the song.  Using chords, here's how to play it:
     ...
     Part 2:  Still holding the (Em) add your pinky to and pick the 3rd string/3rd fret <a>, and the open 2nd string below it <b>.  Then reform the (Dsus4) and repeat the same sequence from above ending in the strum of (Em).

     Part 3:  The last part is a walk-down of picked strings starting at the 3rd string/3rd fret <a>, open 3rd string <g>, 4th string/4th fret <f#>, open 4th string, and open 5th string <a> and on this <a> you begin the song with "On" followed by the (Em) on "long."  The same sequence closes the song.

TIP:  In the last line of the verse hold onto the (Am) through the final word in the line and then move immediately to the (Em).  E.g. “ (Am) . . . before (Em).”


[INTRO][(notes)][:]       [g][-][f#][,]     [d][-][a][-][b][;]       [a][-][b][,]     [g][-][f#][-][d][-][a][-][b][,]     [a][-][g][-][f#][-][d][-][a]

[INTRO][(chords)][:]       [|][Dsus4][|][-][(lift)][-][1][,]     [2][-][3][-][|][Em][|][;]       [3][/][3]     [-]     [2]
...
Here I [D]go, playin' [Em]star again.   There I [C]go, [D]     turn the [Em]pa-aaaaa-jah. [Em]       [Em]
...
[|][Em]Late[|]r in the evening as you [|][Em]lie [|] awake in bed, 
With the [|][D]ec[|]hoes from the amplifiers [|][D]rin[|]gin' in your head.  
You [|][Am]smo[|]ke the day's last cigarette, re [|][Am]mem[|]berin' what she said. [|][E][|]     [|][E][|]
...
[OUTRO][(chords)][:]       [|][Dsus4][|][-][(lift)][-][1][,]     [2][-][3][-][|][Em][|]
