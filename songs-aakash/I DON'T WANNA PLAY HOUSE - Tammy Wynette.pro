...
{t: I DON'T WANNA PLAY HOUSE - Tammy Wynette }
{st: (Sherill/Sutton)  }
{artist: Tammy Wynette }
{composer: Sherill; Sutton}


https://www.youtube.com/watch?v=wuMCBE9yUqg  (Capo 0)

TIP:  For the intro, pick top string/2nd fret, top string/3rd fret, and open 5th string and then immediately into the song.

TIP:  Don't sweat the instrumental walk-up at the key change.  Since you're already playing the (F#), stay with the the (F) shape and play the (G) as (F) on the 3rd fret and (A) as (F) on the 5th fret.  
...
'Cause when [|][E]sh[|]e played house my [|][D]da[|]ddy [|][E7]said[|] good[D]bye. [A]
