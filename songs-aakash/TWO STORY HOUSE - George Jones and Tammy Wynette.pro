...
{subtitle: George Jones and Tammy Wynette}
                                                                                                                                                            .
...
With [C]all our work behind us, we'd [G7]finally settle [|][C]do[|]wn. [|][C][|]   [|][C][|]     [C]
...
We [C]filled the house with everything but [G7]somehow left love [|][C]ou[|]t.  [|][C][|]   [|][C][|]     [C]
