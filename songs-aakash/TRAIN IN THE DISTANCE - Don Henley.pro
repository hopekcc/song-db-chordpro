...
{t: TRAIN IN THE DISTANCE – Don Henley }
{st: (Henley/Lynch) }
{artist: Don Henley }
{composer: Lynch; Don Henley }


https://www.youtube.com/watch?v=N-1poC9IGSc  (Capo 2) (MC0)

TIP:  For the intro, pick the open 4th string <d>, downstroke/upstroke the (D) and repeat and total of sixteen times.  Between versus it’s eight times.


[INTRO][:]       [<d>][-][D][,]     [<d>][-][D][,]     [<d>][-][D][,]     [<d>][-][D][,]     [<d>][-][D][,]     [<d>][-][D][,]     [<d>][-][D][,]     [<d>][-][D] 
...
They [E]will be riding with you, wher[G]ever you may go. [D]     Yeah but you have to [A]go. [|][A][|]
