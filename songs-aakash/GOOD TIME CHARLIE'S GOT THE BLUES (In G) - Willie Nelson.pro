# ----------------------------------------------------------------------------
# GOOD TIME CHARLIE'S GOT THE BLUES (In G) - Willie Nelson/Dwight Yoakam
# ----------------------------------------------------------------------------
{ns}
{t: GOOD TIME CHARLIE'S GOT THE BLUES (In G) - Willie Nelson}
{st: (O'Keefe)}
{artist: Willie Nelson}
{composer: O'Keefe }


TIP:  There are several versions out there.  This one is based on Willie's which means the intro is picked although you can play the chords if you want.  To pick (untransposed), open with the open 2nd string (b).


INTRO:   < Pick the notes to the opening verse through "town" or, using chords > :
...
OUTRO:   < Pick the notes to the opening verse through "town" or, using chords > :
