...
{t: I CAN STILL HEAR DAD SWEARING – Slim Dusty }
{st: (Jewel) }
{artist: Slim Dusty }
{composer: Jewel }
...
TIP:  The intro is a bit much to play with chords.  Start by quickly picking the top string/3rd fret and then the open 5th string, a bar of (C) and then the chords shown in brackets once.  The notes are there if you want to/can pick them out.  Parts or all of this sequence repeats after the verses.
...
And poor old mum [G]scoldin’ like a [C]bush woman [F]can:
“Pray the Lord He’s not [C]listenin’ to the [G]talk from that [|][C]ma[|]n.”
