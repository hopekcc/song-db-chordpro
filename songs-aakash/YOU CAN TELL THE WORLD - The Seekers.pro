...
You can tell the [C]nations about [G]that.   Tell 'em what the [C]Master has [G]done.
Tell 'em that the [C]gospel has [G]come.   Tell 'em that the [C]victory's been [G]won.
