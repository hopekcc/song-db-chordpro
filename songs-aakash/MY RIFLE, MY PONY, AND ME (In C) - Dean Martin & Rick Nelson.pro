...
{t: MY RIFLE, MY PONY, AND ME (In C) – Dean Martin & Rick Nelson }
{st: (Tiomkine/Webster) }
{artist: Dean Martin; Rick Nelson }
{composer: Tiomkine; Webster }
...
TIP:  The version from Rio Bravo is uncapo’d while Dean’s studio version is capo’d at the first fret.  The lyrics are nearly identical with just some differences in the background singers and the duet has no intro as Dean sings the opening verse acapella.  What appears here has all the nuances of the studio version.  
      

[INTRO][(][studio][)][:]      [C]     [F]     [C][,]     [C]     [F]     [|][C][|]


[NC]The sun is sinking in the [|][Em]wes[|]t.   
The [|][Am]catt[|]le go down to the [|][G]stre[|]am.
The [|][C]red[|]wing settles in the [|][Em]nest[|].   
It's [|][Am]time[|], for a cowboy, to [C]dream. [C]     [C] 
...
For my [C]rifle,  [F]pony,  and [C]me.    For my rifle,  my [|][F]po[|]ny,  and [|][C]me[|].    [|][F][|]     [|][C][|]
