...
# ----------------------------------------------------------------------------
{ns}
{t: UNICORN (The)  – The Irish Rovers   }
{st: (Silverstein)  }
...
TIP:  It's not terribly important but the final verse begins with a subtle little three note walk-up.  The notes are 5th string open <a>, 5th string/2nd fret <b>, and 4th string open <d> with the <d> on the word "You'll" to start the final verse.
...
[a][-][b]      [d]You'll see [D]green alligators and [Em]long-necked geese.  
