...
TIP:  For the intro, hit strings 5 - 4 - 3 on the (D) and (C/G), then for the (A) use your index finger, or your thumb over the top, and pick the top string/2nd fret <f#>, the open top string <e>, and (D).  (Notes may or may not transpose.)  
 
  
[INTRO:]     [D]     [C/G][,]     [G]     [A][,]     [f#][-][e]     [D]     [D]
