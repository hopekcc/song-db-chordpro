# ----------------------------------------------------------------------------
# ANGEL FROM MONTGOMERY - John Prine/John Prine & Bonnie Raitt
# ----------------------------------------------------------------------------
{ns}
{t: ANGEL FROM MONTGOMERY - John Prine/John Prine & Bonnie Raitt}
{st: (Prine)}
{artist: John Prine; Bonnie Raitt}
{composer: John Prine}


https://www.youtube.com/watch?v=q3qr4xi0RTk  (Capo 4) (John)

https://www.youtube.com/watch?v=1T5NuI6Ai-o  (Capo 2) (John & Bonnie)

Two versions here, one John playing solo from 2018, and a duet with Bonnie Raitt.  The intro and instrumental bridges are a little different, and Bonnie reverses "thunder" and "lightning" in the first verse.  Bonnie also plays a (C) instead of an (A) in the last line of the verse.  (Rake) means to strum once slowly downward from the 6th string to the 1st string.
 
   
[INTRO][(John):]              [(][rake][)]    [|][D][|][,]       [D]     [D]     [C]     [G]     [D][,]     [D]     [C]     [G]     [D]
...
[D]He wasn't much to [G]look at, just [A]free ramblin' [D]man. [D]
...
To believe in this  [(][rake][)]     [|][G]livi[|]n', 
Is just a  [(][rake][)]     [|][A7]har[|]rrd way, to,  [(][rake][)]     [|][D]go[|].     [D]     [|][D][|]
